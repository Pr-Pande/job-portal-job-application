...
func (mr *MockServiceMockRecorder) GetCompanyData(uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetJobByCompany(uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) GetJobData(uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) StoreCompany(ctx, nc interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) StoreJob(ctx, nc, cid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
